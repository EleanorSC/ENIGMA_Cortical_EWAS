## ---------------------------
##
## Script Purpose: Initial overview of ENIGMA cortical EWAS
## This R script will generate a histogram plot (in .png format) for each cortical ROI in FreeSurfer for ENIGMA
##
...
#
#  Written by Eleanor Conole (eleanor.conole@ed.ac.uk) for the ENIGMA Consortium (2023)
#        Updated for cortical methylation EWAS (October 12 2023)
#
#################################################
